...
pub fn main() {
    ...
    'running: loop {
        ...
        // computer.step(reset, 0b0000_0000_0000_0000);
        // if reset {
        //     display_reset(&mut canvas, &mut computer);
        // }
        reset = false;

        display_screen(&mut canvas, &mut computer);
...
fn display_screen(canvas: &mut WindowCanvas, computer: &mut Computer) {
